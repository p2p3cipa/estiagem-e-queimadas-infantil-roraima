/* Service Worker — Cuidado com o Fogo (Estiagem e Queimadas Infantil)
   Guarda o folder inteiro no aparelho no primeiro acesso com internet,
   para que os acessos seguintes funcionem mesmo offline.
   Para publicar uma atualização, troque a versão do CACHE (ex.: estiagem-queimada-infantil-v2). */

const CACHE = 'estiagem-queimada-infantil-v1';
